...
int main()
{
    ...
    int count = students[0].readData(students);
    ...
    students[0].sortData(students, count);

    students[0].displayData(students, count);

    students[0].saveData(students, count);
